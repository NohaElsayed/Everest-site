...
//        }
    ...
    function list(Request $request)
    {
        ...
        if ($request->has('search')) {
            ...
            $products = Product::where(['added_by' => 'seller', 'user_id' => \auth('seller')->id(),'service' => 'service'])
    ...
    public function stock_limit_list(Request $request, $type)
    {
        ...
        return view('seller-views.service.stock-limit-list', compact('products', 'search', 'request_status', 'sort_oqrderQty'));
    }
    ...
    public function get_variations(Request $request)
    {
        $product = Product::find($request['id']);
        return response()->json([
            'view' => view('seller-views.service.partials._update_stock', compact('product'))->render()
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        $br = Brand::orderBY('name', 'ASC')->get();
        return view('seller-views.service.edit', compact('categories', 'br', 'product', 'product_category'));
