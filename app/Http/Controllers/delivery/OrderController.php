...
class OrderController extends Controller
{
    public function list(Request $request, $status)
    {
        ...
        return view('delivery-views.order.list', compact('orders', 'search','from','to','status'));
    }
    ...
    public function details($id)
    {
        ...
        {
            return view('delivery-views.order.order-details', compact('shipping_address','order', 'linked_orders', 'delivery_men'));
        }else{
            return view('delivery-views.pos.order.order-details', compact('order'));
        }
    ...
    public function generate_invoice($id)
    {
        ...
        $mpdf_view = View::make('delivery-views.order.invoice')->with('order', $order)->with('seller', $seller);
