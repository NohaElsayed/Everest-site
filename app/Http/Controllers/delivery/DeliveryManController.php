...
class DeliveryManController extends Controller
{
    ...
    {
        return view('delivery-views.delivery-man.index');
    }
    ...
    public function list(Request $request)
    {
        ...
        return view('delivery-views.delivery-man.list', compact('delivery_men', 'search'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return response()->json([
            'view' => view('delivery-views.delivery-man.partials._table', compact('delivery_men'))->render()
        ]);
    }
    ...
    public function preview($id)
    {
        ...
        return view('delivery-views.delivery-man.view', compact('dm'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('delivery-views.delivery-man.edit', compact('delivery_man'));
    }
