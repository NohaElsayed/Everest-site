...
<link href="https://fonts.googleapis.com/css2?family=Cairo:wght@200;300;400;500&family=Oswald:wght@500;600&display=swap"
    rel="stylesheet">
<meta property="twitter:description" content="{!! substr($web_config['about']->value,0,100) !!}">
<link rel="shortcut icon" href="{{asset('public/assets/front-end')}}/img/Logo.png" type="image/x-icon">
...
@include('layouts.front-end.partials.shoping')
@endpush
...
$q->active();
...
}])->where(['status'=>1])->where(['deal_type'=>'flash_deal'])->whereDate('start_date','<=',date('Y-m-d'))->
    whereDate('end_date','>=',date('Y-m-d'))->first())

    @if (isset($flash_deals))
    <div class="container">
        <div class="flash-deal-view-all-web row d-flex justify-content-{{Session::get('direction') === "rtl" ? 'start' : 'end'}}"
        ...
        <div class="row d-flex {{Session::get('direction') === "rtl" ? 'flex-row-reverse' : 'flex-row'}}">
            ...
            <div class="flash-deal-view-all-mobile col-md-12"
                style="{{Session::get('direction') === "rtl" ? 'margin-left: 2px;' : 'margin-right:2px;'}}">
                <a class="{{Session::get('direction') === "rtl" ? 'float-left' : 'float-right'}} mt-2 text-capitalize view-all-text"
                    href="{{route('flash-deals',[isset($flash_deals)?$flash_deals['id']:0])}}">
                    {{ \App\CPU\translate('view_all')}}
                    <i
                        class="czi-arrow-{{Session::get('direction') === "rtl" ? 'left-circle mr-1 ml-n1 mt-1 float-left' : 'right-circle ml-1 mr-n1'}}"></i>
    ...
    @include('layouts.front-end.partials.loader')

    @include('layouts.front-end.partials.hero')
    {{--brands--}}
    <!-- <section class="container rtl mt-3">
        ...
        <!-- <div class="row"> -->
            ...
            <!-- <div class="col-lg-9 col-md-9 col-sm-12"
                style="{{Session::get('direction') === "ltr" ? 'direction:rtl' :'direction:ltr'}}">
                ...
                <div class="swiper">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img src="{{asset('/storage/app/public/adverts')}}/{{$b['image']}}" alt=""
                                class="img-fluid">
                        </div>
                        @endforeach
                    </div>
    ...
    ->whereDate('start_date', '<=', date('Y-m-d'))->whereDate('end_date', '>=', date('Y-m-d'))
        ...
        <div class="container rtl">
            <div class="row">
                ...
                <div class="col-xl-3 col-md-4 pb-4 mt-3 pl-0 pr-0">
                    <div class="deal_of_the_day" style="background: {{$web_config['primary_color']}};height: 820px;">
                        ...
                        <div class="d-flex justify-content-center align-items-center" style="width: 70%;margin:auto;">
                            <h1 class="align-items-center" style="color: white">
                                {{ \App\CPU\translate('deal_of_the_day') }}</h1>
                        </div>
                        <div class="recomanded-product-card">
                            ...
                            <div
                                style="background:#ffffff;margin:20px;padding-top: 10px;height: 200px;border-radius: 0px 0px 5px 5px;">
                        ...
                        <div class="recomanded-product-card">
                            ...
                            <div
                                ...
                                <div style="text-align: left; padding: 20px;">
                                    ...
                                    @php($overallRating =
                                    \App\CPU\ProductManager::get_overall_rating($product['reviews']))
                                    <div class="rating-show" style="height:125px; ">
                                        <h5 style="font-weight: 600; color: {{$web_config['primary_color']}}">
                    ...
                    <div class="latest-product-margin"
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="" style="text-align: center;">
                                <span class="for-feature-title"
                                    style="text-align: center;font-size:22px !important; font-weight:700">{{ \App\CPU\translate('latest_products')}}</span>
                            </div>
            ...
            <div class="row px-xl-5">
                <div class="col-md-6 pb-4">
                    <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5"
                        style=" background: #edb007 !important;">
                        <img src="https://codewithsadee.github.io/anon-ecommerce-website/assets/images/newsletter.png"
                            alt="">
                        <div class="position-relative" style="z-index: 1;">
                            <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                            <h1 class="font-weight-semi-bold">Spring Collection</h1>
                ...
                <div class="col-md-6 pb-4">
                    <div class="position-relative bg-secondary text-center text-md-left text-white mb-2 py-5 px-5"
                        ...
                        <div class="position-relative" style="z-index: 1;">
                            <h5 class="text-uppercase text-primary mb-3">20% off the all order</h5>
                            <h1 class="font-weight-semi-bold">Winter Collection</h1>
                            <a href="" class="btn btn-outline-primary py-md-2 px-md-3">Shop Now</a>
                        </div>
                    </div>
                </div>
        ...
        @php($main_section_banner = \App\Model\Banner::where('banner_type','Main Section
        Banner')->where('published',1)->orderBy('id','desc')->latest()->first())
                        ...
                        <div class="card-body">
                            <div class="row d-flex justify-content-between">
                                <div class="categories-title">
                                    <span
                                        style="font-weight: 600;font-size: 16px;">{{ \App\CPU\translate('categories')}}</span>
                                </div>
                                ...
                                @if ($key<10) <div class="text-center" style="margin: 5px;">
                                    <a
                                        ...
                                        <img style="vertical-align: middle; height: 100px;border-radius: 5px;"
                                            ...
                                            alt="{{$category->name}}">
                                        <p class="text-center small " style="margin-top: 5px">
            ...
            <div class="card" style="min-height: 383px;">
                <div class="card-body">
                    ...
                    <div class="row d-flex justify-content-between mt-3">
                        ...
                        @if ($key<10) @if($seller->shop)
                            <div style="margin: 5px;">
                                <center>
                                    <a href="{{route('shopView',['id'=>$seller['id']])}}">
                                        <img style="vertical-align: middle; padding: 2%;width:100px;height: 100px;border-radius: 50%"
                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                            ...
                            <div class="row d-flex justify-content-between m-3">
                                <div>
                                    <img style="height:30px;width:30px;"
                                        src="{{asset("public/assets/front-end/png/best sellings.png")}}" alt="">
                                    <span
                                        style="margin-left:10px;text-transform: uppercase;font-weight: 700;">{{ \App\CPU\translate('best sellings')}}</span>
                                </div>
                                <div>
                                    <a class="text-capitalize view-all-text"
                                ...
                                @if($bestSell->product && $key<3) <div class="col-12 m-1" style="border-style: solid;
                                    ...
                                    <div class="row" style="padding:8px;">
                                        ...
                                        <div class="best-selleing-image">
                                            <a class="d-block d-flex justify-content-center"
                                        ...
                                        <div class="best-selling-details" style="">
                                            ...
                                            <div class="rating-show">
                                                <span class="d-inline-block font-size-sm text-body">
                                                    @for($inc=0;$inc<5;$inc++) @if($inc<$bestSell_overallRating[0]) <i
                                                        class="sr-star czi-star-filled active"></i>
                                                        @else
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row d-flex justify-content-between m-3">
                            <div>
                                <img style="height:30px;width:30px;"
                                    src="{{asset("public/assets/front-end/png/top-rated.png")}}" alt="">
                                <span
                                    style="margin-left:10px;text-transform: uppercase;font-weight: 700;">{{ \App\CPU\translate('top rated')}}</span>
                            </div>
                            <div>
                                <a class="text-capitalize view-all-text"
                            ...
                            @if($top->product && $key<3) <div class="col-12 m-1" style="border-style: solid;
                                ...
                                <div class="row" style="padding:8px;">
                                    ...
                                    <div class="top-rated-details">
                                        ...
                                        <div class="rating-show">
                                            <span class="d-inline-block font-size-sm text-body">
                                                @for($inc=0;$inc<5;$inc++) @if($inc<$top_overallRating[0]) <i
                                                    class="sr-star czi-star-filled active"></i>
                                                    @else
                                                    <i class="sr-star czi-star" style="color:#fea569 !important"></i>
                                                    @endif
        ...
        <div class="container rtl mt-3 mb-3">
            <div class="row">
                @foreach(\App\Model\Banner::where('banner_type','Footer
                Banner')->where('published',1)->orderBy('id','desc')->take(2)->get() as $banner)
                <div class="col-md-6 mt-2 mt-md-0">
        ...
        <div class="container rtl mb-3 p-5">
            <div class="row shipping-policy-web" style="margin-right: 0px; margin-left:0px;">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="box" style="background:#2ebd30; color:#fff">
                        <img class="img-br" src="{{asset('public/assets/front-end/png/faq.png')}}">
                        <p> توصيل سريع</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="box" style="background:#edb007 ; color:#fff">
