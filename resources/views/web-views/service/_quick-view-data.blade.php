...
<div class="modal-header rtl">
    <div>
        <h4 class="modal-title product-title">
            <a class="product-title2" href="{{route('service',$product->slug)}}" data-toggle="tooltip"
    ...
    <div class="row ">
        ...
        <div class="col-lg-6 col-md-6 mt-md-0 mt-sm-3">
            <div class="details" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                <a href="{{route('service',$product->slug)}}" class="h3 mb-2 product-title">{{$product->name}}</a>
                ...
                <div class="flex-start mb-3">
                    <div><strong>{{\App\CPU\translate('Phone')}} : </strong></div>
                    <div><strong id="set-tax-amount" class="mx-2"> {{$product['phone']}}</strong></div>
                </div>
...
{{--                <!-- Product panels-->--}}
                ...
                <form method="post"  action="{{route('store','test')}}" >
                    ...
                    {{ csrf_field() }}
                    <div class="row mb-3">
                        <div><strong>{{\App\CPU\translate('Customer Phone')}} : </strong></div>
                        <input type="hidden" value="{{$product['id']}}">
                        <input type="text" class="form-control" name="phone">
                    </div>
                    <div class="row mb-3">
                        <div><strong>{{\App\CPU\translate('Customer Notes')}} : </strong></div>
                        <textarea id="set-tax-amount" class="form-control"name="notes"></textarea>
                    </div>
                    <div class="row mb-3">
                      <button type="submit" class="btn-primary ">{{\App\CPU\translate('Send')}}</button>
                    </div>
                </form>
