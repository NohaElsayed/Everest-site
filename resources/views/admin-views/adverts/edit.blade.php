...
@section('title', \App\CPU\translate('Advertisement Edit'))
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{ \App\CPU\translate('Advertisement')}} {{ \App\CPU\translate('Update')}}</li>
        </ol>
    </nav>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="h3 mb-0 text-black-50">{{ \App\CPU\translate('Advertisement')}} {{ \App\CPU\translate('Update')}}</h1>
                </div>
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.adverts.update',[$b['id']])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="brand">{{ \App\CPU\translate('Advertisement_logo')}}</label><span class="badge badge-soft-danger">( {{ \App\CPU\translate('ratio')}} 1:1 )</span>
                                    <br>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="text-center">
                                    <img style="border-radius: 10px; max-height:170px;" id="viewer"
                                        ...
                                        src="{{asset('storage/app/public/adverts')}}/{{$b['image']}}" alt="banner image"/>
                                </div>
                            </div>
                        </div>
