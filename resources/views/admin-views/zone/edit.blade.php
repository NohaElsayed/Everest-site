            ...
            <form action="{{route('admin.zone.update', $zone->id)}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="row">
                                {{-- <div class="col-6 shipping_input_group">
                                    <div class="form-group">
                                        <label class="input-label" for="minimum_shipping_charge">{{\App\CPU\translate('messages.minimum_shipping_charge')}} ({{\App\CentralLogics\Helpers::currency_symbol()}})
                                        </label>
                                        <input type="number" id="minimum_shipping_charge" min="0" max="99999999.99" step="0.01" name="minimum_delivery_charge" class="form-control shipping_input" value="{{isset($zone->minimum_shipping_charge) ? $zone->minimum_shipping_charge : ''}}">
                                    </div>                                    
                                </div> --}}

                                {{-- <div class="col-6 shipping_input_group">
                                    <div class="form-group">
                                        <label class="input-label" for="shipping_charge_per_km">{{\App\CPU\translate('messages.per_km_shipping_charge')}} ({{\App\CentralLogics\Helpers::currency_symbol()}})</label>
                                        <input type="number" id="shipping_charge_per_km" min="0" max="99999999.99" step="0.01" name="per_km_delivery_charge" class="form-control shipping_input" value="{{isset($zone->per_km_shipping_charge) ? $zone->per_km_shipping_charge : '' }}">
                                    </div>                                    
                                </div> --}}
                            </div>
                        </div>
