...
@section('title', \App\CPU\translate('Services Add'))
...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{ route('admin.services.store') }}" method="POST"
                                ...
                                <div class="{{ $lang != $default_lang ? 'd-none' : '' }} lang_form"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" {{ $lang == $default_lang ? 'required' : '' }} name="name[]"
                                            id="{{ $lang }}_name" class="form-control" placeholder="New Services">
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="input-label"
                                                for="exampleFormControlInput1">{{ \App\CPU\translate('Service_code_sku') }}
...
{{--                    </div>--}}
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4>{{ \App\CPU\translate('Service price') }}</h4>
                        </div>
                        {{-- <div class="card-body">
                            <div class="form-group"> --}}
                                <div class="row">
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label>{{ \App\CPU\translate('Upload Services images') }}</label><small
