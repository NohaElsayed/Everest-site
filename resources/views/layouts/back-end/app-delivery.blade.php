...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-delivery._header')
    @include('layouts.back-end.partials-delivery._side-bar')
    ...
    <main id="content" role="main" class="main pointer-event" style="background-color: #F7F8FA">
        ...
        <!-- Footer -->
        @include('layouts.back-end.partials-delivery._footer')
        <!-- End Footer -->

        @include('layouts.back-end.partials-delivery._modals')
